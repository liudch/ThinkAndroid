...
import com.ta.annotation.TACompareInject;
...
public class TAComparator<T> implements Comparator<T>
{
			...
			IllegalAccessException
	{
		...
		if (fields != null && fields.length > 0)
		{
			...
			{
				if (field.isAnnotationPresent(TACompareInject.class))
				{
					TACompareInject taCompareInject = field
							.getAnnotation(TACompareInject.class);
